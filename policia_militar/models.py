...
class Ocorrencia(models.Model):
    ...
    data_visita_autor = models.DateField(verbose_name='Data da primeira Visita ao Autor', blank=True, null=True)
    ...
    data_visita_vitima = models.DateField(verbose_name='Data da primeira Visita A Vítima', blank=True, null=True)
    ...
    data_visita_autor_medida_protetiva = models.DateField(verbose_name='Data da primeira Visita ao Autor (Medida Protetiva)', blank=True, null=True)
    ...
    data_visita_vitima_medida_protetiva = models.DateField(verbose_name='Data da primeira Visita A Vítima (Medida Protetiva)', blank=True, null=True)
