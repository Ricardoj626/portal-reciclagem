...
class Ocorrencia(models.Model):
    ...
    data_visita_autor = models.DateField(verbose_name='Data da primeira Visita ao Autor',null=True)
    numero_reds_autor = models.CharField(max_length=20, verbose_name='Número do REDS', null=True)
    observacoes_visita_autor = models.TextField(max_length=2000, verbose_name='Observações', null=True)
    data_visita_vitima = models.DateField(verbose_name='Data da primeira Visita A Vítima', null=True)
    numero_reds_vitima = models.CharField(max_length=20, verbose_name='Número do REDS', null=True)
    observacoes_visita_vitima = models.TextField(max_length=2000, verbose_name='Observações',null=True)

    data_visita_autor_medida_protetiva = models.DateField(verbose_name='Data da primeira Visita ao Autor (Medida Protetiva)', null=True)
    numero_reds_autor_medida_protetiva = models.CharField(max_length=20, verbose_name='Número do REDS', null=True)
    observacoes_visita_autor_medida_protetiva = models.TextField(max_length=2000, verbose_name='Observações', null=True)
    data_visita_vitima_medida_protetiva = models.DateField(verbose_name='Data da primeira Visita A Vítima (Medida Protetiva)',null=True)
    numero_reds_vitima_medida_protetiva = models.CharField(max_length=20, verbose_name='Número do REDS',  null=True)
    observacoes_visita_vitima_medida_protetiva = models.TextField(max_length=2000, verbose_name='Observações',null=True)
    ultima_atualizacao = models.DateTimeField(auto_now=True, editable=False)
    def __str__(self):
