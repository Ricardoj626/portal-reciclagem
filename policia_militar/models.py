...
class Ocorrencia(models.Model):
    ...
    data_visita_autor = models.DateField(verbose_name='Data da primeira Visita ao Autor')
    ...
    data_visita_vitima = models.DateField(verbose_name='Data da primeira Visita A Vítima')
    ...
    data_visita_autor_medida_protetiva = models.DateField(verbose_name='Data da primeira Visita ao Autor (Medida Protetiva)')
    ...
    data_visita_vitima_medida_protetiva = models.DateField(verbose_name='Data da primeira Visita A Vítima (Medida Protetiva)')
